...
def main_method():
  ...
  exec_plot_speed_time_ind("Plot_speed_time_" + cmd_call_args_.pdf_file_out, V_START, µ_dyn)
  exec_plot_distance_time_ind("Plot_distance_time_" + cmd_call_args_.pdf_file_out, V_START, µ_dyn, Incline)
